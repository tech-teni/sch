...
$url = 'https://eschool-ng.com/free-eSchool/portal/fetchdata_bonavistaschools.php';
$request_url = $url;
			...
			<div class="container">
				<nav id="navbar-example" class="navbar navbar-expand-lg">
					<a class="navbar-brand jk" href="index.html">
						<img src="./img/img\preciousLogo.png" alt="logo">
					</a>
				...
				<div class="row">
					<div class="col-sm-12 col-md-6 col-lg-3">
						<div class="footer-item">
							<img src="img\preciousLogo.png" alt="logo bottom" class="logo-bottom">
						...
						<div class="footer-item">
							...
							<ul class="list-info">
								<li>
									...
									<div class="info-text">Address: No 5 Olabisi Olaitan street, Omolade, Igando, Lagos
</div>
								</li>
								<li>
									<div class="info-icon">
									...
									<div class="info-text">08060089905, 08099397370</div>
								</li>
								<li>
									<div class="info-icon">
